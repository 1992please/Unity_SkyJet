    ...
    void FixedUpdate()
    {
        ...
        if (Scale)
        {
            ...
            if (R.x >= max)
            {
                ...
                leftHand.position = new Vector3(-max, rightHand.position.y, rightHand.position.z);
        ...
        } else if (!Scale)
        {
            ...
            if (R.x <= min)
            {
                ...
                leftHand.position = new Vector3(-min, rightHand.position.y, rightHand.position.z);
                animL.SetFloat(hash.speedFloat, 0);
                animR.SetFloat(hash.speedFloat, 0);
            } else
            {
