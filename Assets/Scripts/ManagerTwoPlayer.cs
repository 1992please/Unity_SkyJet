    ...
    IEnumerator MakeEnemies()
    {
        while (true)
        {
            ...
            if (barrierCounter < 38)
            {
                ...
                enemy = Enemy.GetComponent<EnemyScriptT>();
                //enemy.changeScale = true;                enemy.Gap = Random.Range(4.5f, 5.5f);
            ...
            enemy.ScaleNL = Random.Range(minEnemyScale, maxEnemyScale);
            enemy.ScaleNR = Random.Range(minEnemyScale, maxEnemyScale);
            enemy.GapL = Random.Range(4.5f, 5.5f);
            enemy.GapR = Random.Range(4.5f, 5.5f);
